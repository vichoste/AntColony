...
namespace AntColony.Main {
	...
	/// </summary>
	internal class MaxCoordinateConverter : IValueConverter {
		...
		public object Convert(object value, Type targetType, object parameter, CultureInfo culture) => value is double maxCoordinate ? maxCoordinate.ToString() : "0";
		/// <summary>
