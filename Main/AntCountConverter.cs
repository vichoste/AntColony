...
public class AntCountConverter : IValueConverter {
	...
	public object Convert(object value, Type targetType, object parameter, CultureInfo culture) {
		return value is int antCount ? antCount.ToString() : MainModel.MaxAntCount.ToString();
	}
	...
	public object ConvertBack(object value, Type targetType, object parameter, CultureInfo culture) {
		return value is string antCount && int.TryParse(antCount, out var result) ? result : MainModel.MinAntCount;
	}
	#endregion
}